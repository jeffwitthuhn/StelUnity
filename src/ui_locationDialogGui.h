...
public:
    ...
    QLabel *label_6;
    QCheckBox *useCustomTimeZoneCheckBox;
    QLabel *timeZoneLabel;
    QLabel *label_3;
    QComboBox *timeZoneNameComboBox;
    ...
    void setupUi(QWidget *locationDialogForm)
    {
        ...
        locationDialogForm->resize(700, 506);
        ...
        useAsDefaultLocationCheckBox = new QCheckBox(frame_4);
        useAsDefaultLocationCheckBox->setObjectName(QStringLiteral("useAsDefaultLocationCheckBox"));

        gridLayout_4->addWidget(useAsDefaultLocationCheckBox, 5, 0, 1, 2);
        ...
        useIpQueryCheckBox = new QCheckBox(frame_4);
        useIpQueryCheckBox->setObjectName(QStringLiteral("useIpQueryCheckBox"));

        gridLayout_4->addWidget(useIpQueryCheckBox, 4, 0, 1, 2);
        ...
        useCustomTimeZoneCheckBox = new QCheckBox(frame_5);
        useCustomTimeZoneCheckBox->setObjectName(QStringLiteral("useCustomTimeZoneCheckBox"));

        gridLayout_5->addWidget(useCustomTimeZoneCheckBox, 4, 0, 1, 2);

        timeZoneLabel = new QLabel(frame_5);
        timeZoneLabel->setObjectName(QStringLiteral("timeZoneLabel"));

        gridLayout_5->addWidget(timeZoneLabel, 3, 0, 1, 1);
        ...
        timeZoneNameComboBox = new QComboBox(frame_5);
        timeZoneNameComboBox->setObjectName(QStringLiteral("timeZoneNameComboBox"));
        timeZoneNameComboBox->setEnabled(true);
        timeZoneNameComboBox->setEditable(true);
        timeZoneNameComboBox->setInsertPolicy(QComboBox::NoInsert);

        gridLayout_5->addWidget(timeZoneNameComboBox, 3, 1, 1, 1);
        ...
        dstCheckBox = new QCheckBox(frame_5);
        dstCheckBox->setObjectName(QStringLiteral("dstCheckBox"));

        gridLayout_5->addWidget(dstCheckBox, 5, 0, 1, 2);
    ...
    void retranslateUi(QWidget *locationDialogForm)
    {
        ...
        deleteLocationFromListPushButton->setText(QApplication::translate("locationDialogForm", "Delete from list", 0));
        ...
        useCustomTimeZoneCheckBox->setText(QApplication::translate("locationDialogForm", "Use custom time zone", 0));
        timeZoneLabel->setText(QApplication::translate("locationDialogForm", "Time zone:", 0));
...
#ifndef QT_NO_TOOLTIP
        dstCheckBox->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        dstCheckBox->setText(QApplication::translate("locationDialogForm", "Enable daylight saving time", 0));
