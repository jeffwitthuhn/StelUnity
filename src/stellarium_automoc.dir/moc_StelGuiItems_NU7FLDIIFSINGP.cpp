...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StelProgressBarMgr_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StelProgressBarMgr_t qt_meta_stringdata_StelProgressBarMgr = {
    {
QT_MOC_LITERAL(0, 0, 18), // "StelProgressBarMgr"
QT_MOC_LITERAL(1, 19, 14), // "addProgressBar"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 29), // "const StelProgressController*"
QT_MOC_LITERAL(4, 65, 1), // "p"
QT_MOC_LITERAL(5, 67, 17), // "removeProgressBar"
QT_MOC_LITERAL(6, 85, 13) // "oneBarChanged"

    },
    "StelProgressBarMgr\0addProgressBar\0\0"
    "const StelProgressController*\0p\0"
    "removeProgressBar\0oneBarChanged"
};
...
const QMetaObject StelProgressBarMgr::staticMetaObject = {
    { &QGraphicsWidget::staticMetaObject, qt_meta_stringdata_StelProgressBarMgr.data,
      qt_meta_data_StelProgressBarMgr,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StelProgressBarMgr::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StelProgressBarMgr.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CornerButtons_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CornerButtons_t qt_meta_stringdata_CornerButtons = {
    {
QT_MOC_LITERAL(0, 0, 13) // "CornerButtons"
...
const QMetaObject CornerButtons::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CornerButtons.data,
      qt_meta_data_CornerButtons,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_CornerButtons.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StelButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StelButton_t qt_meta_stringdata_StelButton = {
    {
QT_MOC_LITERAL(0, 0, 10), // "StelButton"
QT_MOC_LITERAL(1, 11, 7), // "toggled"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 9), // "triggered"
QT_MOC_LITERAL(4, 30, 12), // "hoverChanged"
QT_MOC_LITERAL(5, 43, 1), // "b"
QT_MOC_LITERAL(6, 45, 10), // "setChecked"
QT_MOC_LITERAL(7, 56, 16), // "animValueChanged"
...
const QMetaObject StelButton::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StelButton.data,
      qt_meta_data_StelButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_StelButton.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LeftStelBar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LeftStelBar_t qt_meta_stringdata_LeftStelBar = {
    {
QT_MOC_LITERAL(0, 0, 11), // "LeftStelBar"
QT_MOC_LITERAL(1, 12, 18), // "buttonHoverChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 1) // "b"

    },
    "LeftStelBar\0buttonHoverChanged\0\0b"
};
#undef QT_MOC_LITERAL
...
const QMetaObject LeftStelBar::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LeftStelBar.data,
      qt_meta_data_LeftStelBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_LeftStelBar.stringdata0))
...
const QMetaObject BottomStelBar::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BottomStelBar.data,
      qt_meta_data_BottomStelBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_BottomStelBar.stringdata0))
