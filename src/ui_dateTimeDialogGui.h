...
public:
    ...
    void setupUi(QWidget *dateTimeDialogForm)
    {
        ...
        spinner_jd->setDecimals(6);
        spinner_jd->setMinimum(-1e+08);
        spinner_jd->setMaximum(1e+08);
        spinner_jd->setSingleStep(1e-05);
        ...
        spinner_mjd->setDecimals(6);
        spinner_mjd->setMinimum(-1e+08);
        spinner_mjd->setMaximum(1e+08);
        spinner_mjd->setSingleStep(1e-05);
    ...
    void retranslateUi(QWidget *dateTimeDialogForm)
    {
        ...
        label_5->setToolTip(QApplication::translate("dateTimeDialogForm", "Julian Day", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        label_6->setToolTip(QApplication::translate("dateTimeDialogForm", "Modified Julian Day", 0));
#endif // QT_NO_TOOLTIP
        dateTimeTabWidget->setTabText(dateTimeTabWidget->indexOf(julianDateTab), QApplication::translate("dateTimeDialogForm", "Julian Day", 0));
