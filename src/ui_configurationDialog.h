...
public:
    ...
    QGroupBox *groupBox_LanguageSettings;
    ...
    QGroupBox *groupBox_EphemerisSettings;
    QGridLayout *gridLayout_ephemeris;
    QGridLayout *EphemerisGridLayout;
    QLabel *de431label;
    QLabel *de430label;
    QCheckBox *de431checkBox;
    QCheckBox *de430checkBox;
    QLabel *label_VSOP87used;
    ...
    QCheckBox *checkBoxSupergalacticCoordinates;
    QCheckBox *checkBoxType;
    QCheckBox *checkBoxAbsoluteMag;
    QCheckBox *checkBoxEclipticCoordsOfDate;
    ...
    QCheckBox *checkBoxEclipticCoordsJ2000;
    ...
    QGridLayout *gridLayoutFmt;
    QLabel *dateFormatsLabel;
    QLabel *timeFormatsLabel;
    QComboBox *dateFormatsComboBox;
    QComboBox *timeFormatsComboBox;
    QRadioButton *jdRadioButton;
    QRadioButton *dtRadioButton;
    ...
    QCheckBox *nutationCheckBox;
    QCheckBox *azimuthFromSouthcheckBox;
    QCheckBox *showToastSurveyButtonCheckbox;
    QCheckBox *autoChangeLandscapesCheckBox;
    QCheckBox *showBookmarksButtonCheckBox;
    ...
    void setupUi(QWidget *configurationDialogForm)
    {
        ...
        configurationDialogForm->resize(512, 579);
        ...
        groupBox_LanguageSettings = new QGroupBox(page);
        groupBox_LanguageSettings->setObjectName(QStringLiteral("groupBox_LanguageSettings"));
        gridLayout_4 = new QGridLayout(groupBox_LanguageSettings);
        gridLayout_4->setObjectName(QStringLiteral("gridLayout_4"));
        gridLayout_4->setContentsMargins(0, 0, 0, 0);
        languageGridLayout = new QGridLayout();
        languageGridLayout->setObjectName(QStringLiteral("languageGridLayout"));
        programLanguageLabel = new QLabel(groupBox_LanguageSettings);
        ...
        programLanguageComboBox = new QComboBox(groupBox_LanguageSettings);
        ...
        skycultureLanguageLabel = new QLabel(groupBox_LanguageSettings);
        ...
        skycultureLanguageComboBox = new QComboBox(groupBox_LanguageSettings);
        ...
        gridLayout_4->addLayout(languageGridLayout, 0, 0, 1, 1);


        verticalLayout_10->addWidget(groupBox_LanguageSettings);

        groupBox_EphemerisSettings = new QGroupBox(page);
        groupBox_EphemerisSettings->setObjectName(QStringLiteral("groupBox_EphemerisSettings"));
        gridLayout_ephemeris = new QGridLayout(groupBox_EphemerisSettings);
        gridLayout_ephemeris->setObjectName(QStringLiteral("gridLayout_ephemeris"));
        gridLayout_ephemeris->setContentsMargins(0, 0, 0, 0);
        EphemerisGridLayout = new QGridLayout();
        EphemerisGridLayout->setObjectName(QStringLiteral("EphemerisGridLayout"));
        de431label = new QLabel(groupBox_EphemerisSettings);
        de431label->setObjectName(QStringLiteral("de431label"));

        EphemerisGridLayout->addWidget(de431label, 1, 1, 1, 1);

        de430label = new QLabel(groupBox_EphemerisSettings);
        de430label->setObjectName(QStringLiteral("de430label"));

        EphemerisGridLayout->addWidget(de430label, 0, 1, 1, 1);

        de431checkBox = new QCheckBox(groupBox_EphemerisSettings);
        de431checkBox->setObjectName(QStringLiteral("de431checkBox"));

        EphemerisGridLayout->addWidget(de431checkBox, 1, 0, 1, 1);

        de430checkBox = new QCheckBox(groupBox_EphemerisSettings);
        de430checkBox->setObjectName(QStringLiteral("de430checkBox"));

        EphemerisGridLayout->addWidget(de430checkBox, 0, 0, 1, 1);

        label_VSOP87used = new QLabel(groupBox_EphemerisSettings);
        label_VSOP87used->setObjectName(QStringLiteral("label_VSOP87used"));

        EphemerisGridLayout->addWidget(label_VSOP87used, 2, 0, 1, 2);


        gridLayout_ephemeris->addLayout(EphemerisGridLayout, 0, 0, 1, 1);


        verticalLayout_10->addWidget(groupBox_EphemerisSettings);
        ...
        checkBoxSupergalacticCoordinates = new QCheckBox(groupBoxDisplayedFields);
        buttonGroupDisplayedFields->addButton(checkBoxSupergalacticCoordinates);
        checkBoxSupergalacticCoordinates->setObjectName(QStringLiteral("checkBoxSupergalacticCoordinates"));

        gridLayoutDisplayedFields->addWidget(checkBoxSupergalacticCoordinates, 3, 1, 1, 1);
        ...
        gridLayoutDisplayedFields->addWidget(checkBoxType, 7, 0, 1, 1);
        ...
        checkBoxEclipticCoordsOfDate = new QCheckBox(groupBoxDisplayedFields);
        buttonGroupDisplayedFields->addButton(checkBoxEclipticCoordsOfDate);
        checkBoxEclipticCoordsOfDate->setObjectName(QStringLiteral("checkBoxEclipticCoordsOfDate"));

        gridLayoutDisplayedFields->addWidget(checkBoxEclipticCoordsOfDate, 5, 0, 1, 1);
        ...
        gridLayoutDisplayedFields->addWidget(checkBoxExtra, 7, 1, 1, 1);
        ...
        gridLayoutDisplayedFields->addWidget(checkBoxSize, 6, 0, 1, 1);
        ...
        gridLayoutDisplayedFields->addWidget(checkBoxAltAz, 5, 1, 1, 1);
        ...
        gridLayoutDisplayedFields->addWidget(checkBoxDistance, 6, 1, 1, 1);
        ...
        checkBoxEclipticCoordsJ2000 = new QCheckBox(groupBoxDisplayedFields);
        buttonGroupDisplayedFields->addButton(checkBoxEclipticCoordsJ2000);
        checkBoxEclipticCoordsJ2000->setObjectName(QStringLiteral("checkBoxEclipticCoordsJ2000"));

        gridLayoutDisplayedFields->addWidget(checkBoxEclipticCoordsJ2000, 4, 0, 1, 1);
        ...
        gridLayoutDisplayedFields->addWidget(checkBoxHourAngle, 4, 1, 1, 1);
        ...
        checkBoxConstellation = new QCheckBox(groupBoxDisplayedFields);
        buttonGroupDisplayedFields->addButton(checkBoxConstellation);
        checkBoxConstellation->setObjectName(QStringLiteral("checkBoxConstellation"));

        gridLayoutDisplayedFields->addWidget(checkBoxConstellation, 8, 0, 1, 1);
        ...
        gridLayoutFmt = new QGridLayout(groupBox_2);
        gridLayoutFmt->setObjectName(QStringLiteral("gridLayoutFmt"));
        gridLayoutFmt->setContentsMargins(0, 0, 0, 0);
        dateFormatsLabel = new QLabel(groupBox_2);
        dateFormatsLabel->setObjectName(QStringLiteral("dateFormatsLabel"));
        dateFormatsLabel->setAlignment(Qt::AlignCenter);

        gridLayoutFmt->addWidget(dateFormatsLabel, 0, 2, 1, 1);

        timeFormatsLabel = new QLabel(groupBox_2);
        timeFormatsLabel->setObjectName(QStringLiteral("timeFormatsLabel"));
        timeFormatsLabel->setAlignment(Qt::AlignCenter);

        gridLayoutFmt->addWidget(timeFormatsLabel, 0, 4, 1, 1);

        dateFormatsComboBox = new QComboBox(groupBox_2);
        dateFormatsComboBox->setObjectName(QStringLiteral("dateFormatsComboBox"));

        gridLayoutFmt->addWidget(dateFormatsComboBox, 0, 3, 1, 1);

        timeFormatsComboBox = new QComboBox(groupBox_2);
        timeFormatsComboBox->setObjectName(QStringLiteral("timeFormatsComboBox"));

        gridLayoutFmt->addWidget(timeFormatsComboBox, 0, 5, 1, 1);

        jdRadioButton = new QRadioButton(groupBox_2);
        jdRadioButton->setObjectName(QStringLiteral("jdRadioButton"));
        jdRadioButton->setText(QStringLiteral("JD"));

        gridLayoutFmt->addWidget(jdRadioButton, 0, 0, 1, 1);

        dtRadioButton = new QRadioButton(groupBox_2);
        dtRadioButton->setObjectName(QStringLiteral("dtRadioButton"));
        QSizePolicy sizePolicy4(QSizePolicy::Minimum, QSizePolicy::Minimum);
        sizePolicy4.setHorizontalStretch(0);
        sizePolicy4.setVerticalStretch(0);
        sizePolicy4.setHeightForWidth(dtRadioButton->sizePolicy().hasHeightForWidth());
        dtRadioButton->setSizePolicy(sizePolicy4);
        dtRadioButton->setMaximumSize(QSize(20, 16777215));
        dtRadioButton->setText(QStringLiteral(""));
        dtRadioButton->setChecked(true);

        gridLayoutFmt->addWidget(dtRadioButton, 0, 1, 1, 1);
        ...
        gridLayoutOptions->setContentsMargins(0, 0, 0, 0);
        ...
        gridLayoutOptions->addWidget(autoZoomResetsDirectionCheckbox, 8, 0, 1, 2);
        ...
        gridLayoutOptions->addWidget(decimalDegreeCheckBox, 4, 1, 1, 1);
        ...
        topocentricCheckBox = new QCheckBox(groupBox_7);
        topocentricCheckBox->setObjectName(QStringLiteral("topocentricCheckBox"));

        gridLayoutOptions->addWidget(topocentricCheckBox, 5, 1, 1, 1);
        ...
        gridLayoutOptions->addWidget(autoEnableAtmosphereCheckBox, 4, 0, 1, 1);
        ...
        nutationCheckBox = new QCheckBox(groupBox_7);
        nutationCheckBox->setObjectName(QStringLiteral("nutationCheckBox"));

        gridLayoutOptions->addWidget(nutationCheckBox, 5, 0, 1, 1);

        azimuthFromSouthcheckBox = new QCheckBox(groupBox_7);
        azimuthFromSouthcheckBox->setObjectName(QStringLiteral("azimuthFromSouthcheckBox"));

        gridLayoutOptions->addWidget(azimuthFromSouthcheckBox, 6, 0, 1, 1);

        showToastSurveyButtonCheckbox = new QCheckBox(groupBox_7);
        showToastSurveyButtonCheckbox->setObjectName(QStringLiteral("showToastSurveyButtonCheckbox"));

        gridLayoutOptions->addWidget(showToastSurveyButtonCheckbox, 3, 1, 1, 1);

        autoChangeLandscapesCheckBox = new QCheckBox(groupBox_7);
        autoChangeLandscapesCheckBox->setObjectName(QStringLiteral("autoChangeLandscapesCheckBox"));

        gridLayoutOptions->addWidget(autoChangeLandscapesCheckBox, 6, 1, 1, 1);

        showBookmarksButtonCheckBox = new QCheckBox(groupBox_7);
        showBookmarksButtonCheckBox->setObjectName(QStringLiteral("showBookmarksButtonCheckBox"));

        gridLayoutOptions->addWidget(showBookmarksButtonCheckBox, 3, 0, 1, 1);
        ...
        sizePolicy5.setHeightForWidth(screenshotBrowseButton->sizePolicy().hasHeightForWidth());
        screenshotBrowseButton->setSizePolicy(sizePolicy5);
        ...
        pluginsInfoBrowser->setOpenExternalLinks(true);
        ...
        QWidget::setTabOrder(checkBoxGalacticCoordinates, checkBoxSupergalacticCoordinates);
        QWidget::setTabOrder(checkBoxSupergalacticCoordinates, checkBoxRaDecOfDate);
        ...
        QWidget::setTabOrder(checkBoxType, checkBoxEclipticCoordsJ2000);
        QWidget::setTabOrder(checkBoxEclipticCoordsJ2000, checkBoxEclipticCoordsOfDate);
        QWidget::setTabOrder(checkBoxEclipticCoordsOfDate, enableKeysNavigationCheckBox);
    ...
    void retranslateUi(QWidget *configurationDialogForm)
    {
        ...
        groupBox_LanguageSettings->setTitle(QApplication::translate("configurationDialogForm", "Language settings", 0));
        ...
        groupBox_EphemerisSettings->setToolTip(QApplication::translate("configurationDialogForm", "This feature has not been thoroughly tested yet!", 0));
#endif // QT_NO_TOOLTIP
        groupBox_EphemerisSettings->setTitle(QApplication::translate("configurationDialogForm", "Ephemeris settings (experimental)", 0));
        de431label->setText(QApplication::translate("configurationDialogForm", "Not installed", 0));
        de430label->setText(QApplication::translate("configurationDialogForm", "Not installed", 0));
#ifndef QT_NO_TOOLTIP
        de431checkBox->setToolTip(QApplication::translate("configurationDialogForm", "DE431 provides position data for years -13000...+17000. For special applications only.", 0));
#endif // QT_NO_TOOLTIP
        de431checkBox->setText(QApplication::translate("configurationDialogForm", "Use DE431 (long-time data)", 0));
#ifndef QT_NO_TOOLTIP
        de430checkBox->setToolTip(QApplication::translate("configurationDialogForm", "DE430 provides highest accuracy, only for years 1550...2650.", 0));
#endif // QT_NO_TOOLTIP
        de430checkBox->setText(QApplication::translate("configurationDialogForm", "Use DE430 (high accuracy)", 0));
#ifndef QT_NO_TOOLTIP
        label_VSOP87used->setToolTip(QApplication::translate("configurationDialogForm", "Using VSOP87 is recommended for years -4000...+8000 only, but delivers useful positions outside this range.", 0));
#endif // QT_NO_TOOLTIP
        label_VSOP87used->setText(QApplication::translate("configurationDialogForm", "VSOP87/ELP2000-82B is used when these are not installed or not activated.", 0));
...
#ifndef QT_NO_TOOLTIP
        checkBoxRaDecOfDate->setToolTip(QApplication::translate("configurationDialogForm", "Equatorial coordinates, equinox of date", 0));
#endif // QT_NO_TOOLTIP
        checkBoxRaDecOfDate->setText(QApplication::translate("configurationDialogForm", "Right ascension/Declination (of date)", 0));
        checkBoxSupergalacticCoordinates->setText(QApplication::translate("configurationDialogForm", "Supergalactic coordinates", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkBoxEclipticCoordsOfDate->setToolTip(QApplication::translate("configurationDialogForm", "Ecliptic coordinates, equinox of date (only for Earth)", 0));
#endif // QT_NO_TOOLTIP
        checkBoxEclipticCoordsOfDate->setText(QApplication::translate("configurationDialogForm", "Ecliptic coordinates (of date)", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkBoxRaDecJ2000->setToolTip(QApplication::translate("configurationDialogForm", "Equatorial coordinates, equinox of J2000.0", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkBoxEclipticCoordsJ2000->setToolTip(QApplication::translate("configurationDialogForm", "Ecliptic coordinates, equinox J2000.0", 0));
#endif // QT_NO_TOOLTIP
        checkBoxEclipticCoordsJ2000->setText(QApplication::translate("configurationDialogForm", "Ecliptic coordinates (J2000)", 0));
#ifndef QT_NO_TOOLTIP
        checkBoxHourAngle->setToolTip(QApplication::translate("configurationDialogForm", "Equatorial coordinates, equinox of date", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkBoxConstellation->setToolTip(QApplication::translate("configurationDialogForm", "3-letter IAU constellation abbreviation", 0));
#endif // QT_NO_TOOLTIP
        checkBoxConstellation->setText(QApplication::translate("configurationDialogForm", "Constellation", 0));
...
#ifndef QT_NO_TOOLTIP
        groupBox_2->setToolTip(QApplication::translate("configurationDialogForm", "These settings control the way time and date are displayed in the bottom bar.", 0));
#endif // QT_NO_TOOLTIP
        groupBox_2->setTitle(QApplication::translate("configurationDialogForm", "Display formats of date and time", 0));
        dateFormatsLabel->setText(QApplication::translate("configurationDialogForm", "Date:", 0));
        timeFormatsLabel->setText(QApplication::translate("configurationDialogForm", "and time:", 0));
...
#ifndef QT_NO_TOOLTIP
        topocentricCheckBox->setToolTip(QApplication::translate("configurationDialogForm", "Activate to view as seen from surface of the planet (recommended). If switched off, display planetocentric view.", 0));
#endif // QT_NO_TOOLTIP
        topocentricCheckBox->setText(QApplication::translate("configurationDialogForm", "Topocentric coordinates", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        selectSingleConstellationButton->setToolTip(QApplication::translate("configurationDialogForm", "Hide other constellations when you click one", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
...
#ifndef QT_NO_TOOLTIP
        nutationCheckBox->setToolTip(QApplication::translate("configurationDialogForm", "Nutation is a small wobble of Earth's axis, amounting to a few arcseconds.", 0));
#endif // QT_NO_TOOLTIP
        nutationCheckBox->setText(QApplication::translate("configurationDialogForm", "Include nutation", 0));
#ifndef QT_NO_TOOLTIP
        azimuthFromSouthcheckBox->setToolTip(QApplication::translate("configurationDialogForm", "Activate this option to calculate azimuth from south towards west.", 0));
#endif // QT_NO_TOOLTIP
        azimuthFromSouthcheckBox->setText(QApplication::translate("configurationDialogForm", "Azimuth from South", 0));
#ifndef QT_NO_TOOLTIP
        showToastSurveyButtonCheckbox->setToolTip(QApplication::translate("configurationDialogForm", "Toggle display of the button for Digitized Sky Survey.", 0));
#endif // QT_NO_TOOLTIP
        showToastSurveyButtonCheckbox->setText(QApplication::translate("configurationDialogForm", "Show DSS button", 0));
#ifndef QT_NO_TOOLTIP
        autoChangeLandscapesCheckBox->setToolTip(QApplication::translate("configurationDialogForm", "Automatic change of landscape when planet is changed", 0));
#endif // QT_NO_TOOLTIP
        autoChangeLandscapesCheckBox->setText(QApplication::translate("configurationDialogForm", "Auto select landscapes", 0));
        showBookmarksButtonCheckBox->setText(QApplication::translate("configurationDialogForm", "Show bookmarks button", 0));
