...
const QMetaObject TuiNodeEnum::staticMetaObject = {
    { &TuiNodeEditable::staticMetaObject, qt_meta_stringdata_TuiNodeEnum.data,
      qt_meta_data_TuiNodeEnum,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TuiNodeEnum::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeEnum.stringdata0))
