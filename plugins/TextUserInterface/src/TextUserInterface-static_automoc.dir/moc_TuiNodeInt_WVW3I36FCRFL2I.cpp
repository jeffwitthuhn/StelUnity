...
const QMetaObject TuiNodeInt::staticMetaObject = {
    { &TuiNodeEditable::staticMetaObject, qt_meta_stringdata_TuiNodeInt.data,
      qt_meta_data_TuiNodeInt,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TuiNodeInt::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeInt.stringdata0))
