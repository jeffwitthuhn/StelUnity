...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TuiNodeColor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TuiNodeColor_t qt_meta_stringdata_TuiNodeColor = {
    {
QT_MOC_LITERAL(0, 0, 12), // "TuiNodeColor"
...
QT_MOC_LITERAL(4, 29, 1) // "c"
    ...
    "TuiNodeColor\0setValue\0\0Vec3f\0c"
};
...
const QMetaObject TuiNodeColor::staticMetaObject = {
    { &TuiNodeEditable::staticMetaObject, qt_meta_stringdata_TuiNodeColor.data,
      qt_meta_data_TuiNodeColor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TuiNodeColor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeColor.stringdata0))
