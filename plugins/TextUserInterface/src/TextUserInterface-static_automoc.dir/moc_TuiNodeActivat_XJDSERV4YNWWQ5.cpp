...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TuiNodeActivate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TuiNodeActivate_t qt_meta_stringdata_TuiNodeActivate = {
    {
QT_MOC_LITERAL(0, 0, 15), // "TuiNodeActivate"
QT_MOC_LITERAL(1, 16, 8), // "activate"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "TuiNodeActivate\0activate\0"
};
...
const QMetaObject TuiNodeActivate::staticMetaObject = {
    { &TuiNode::staticMetaObject, qt_meta_stringdata_TuiNodeActivate.data,
      qt_meta_data_TuiNodeActivate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TuiNodeActivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeActivate.stringdata0))
