...
const QMetaObject TuiNodeBool::staticMetaObject = {
    { &TuiNodeEditable::staticMetaObject, qt_meta_stringdata_TuiNodeBool.data,
      qt_meta_data_TuiNodeBool,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TuiNodeBool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeBool.stringdata0))
