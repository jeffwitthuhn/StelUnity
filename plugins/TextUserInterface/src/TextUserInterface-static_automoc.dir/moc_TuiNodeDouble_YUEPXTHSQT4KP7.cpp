...
const QMetaObject TuiNodeDouble::staticMetaObject = {
    { &TuiNodeEditable::staticMetaObject, qt_meta_stringdata_TuiNodeDouble.data,
      qt_meta_data_TuiNodeDouble,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TuiNodeDouble::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TuiNodeDouble.stringdata0))
