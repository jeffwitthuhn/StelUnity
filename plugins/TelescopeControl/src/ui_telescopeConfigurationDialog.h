...
public:
    ...
    void setupUi(QWidget *telescopeConfigurationDialog)
    {
        ...
        telescopeConfigurationDialog->resize(565, 480);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 549, 520));
        ...
        comboSerialPort = new QComboBox(groupBoxDeviceSettings);
        comboSerialPort->setObjectName(QStringLiteral("comboSerialPort"));
        comboSerialPort->setEditable(true);

        horizontalLayoutSerialPort->addWidget(comboSerialPort);
        ...
        QWidget::setTabOrder(checkBoxConnectAtStartup, comboBoxDeviceModel);
