...
public:
    ...
    QComboBox *comboBoxStoredPoints;
    QToolButton *toolButtonStoredPoints;
    QFrame *frameFormat;
    ...
    void setupUi(QWidget *slewDialog)
    {
        ...
        verticalLayout_4 = new QVBoxLayout(slewDialog);
        ...
        verticalLayout_4->addWidget(labelNoTelescopes);
        ...
        comboBoxStoredPoints = new QComboBox(groupBoxSlew);
        comboBoxStoredPoints->setObjectName(QStringLiteral("comboBoxStoredPoints"));

        horizontalLayout_3->addWidget(comboBoxStoredPoints);

        toolButtonStoredPoints = new QToolButton(groupBoxSlew);
        toolButtonStoredPoints->setObjectName(QStringLiteral("toolButtonStoredPoints"));

        horizontalLayout_3->addWidget(toolButtonStoredPoints);
        ...
        verticalLayout_4->addWidget(groupBoxSlew);
...
"margin-bottom:10px;"));
        ...
        verticalLayout_4->addWidget(pushButtonConfigure);
    ...
    void retranslateUi(QWidget *slewDialog)
    {
        ...
        toolButtonStoredPoints->setText(QApplication::translate("slewDialog", "...", 0));
