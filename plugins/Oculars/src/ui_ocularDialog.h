...
public:
    ...
    QCheckBox *semiTransparencyCheckBox;
    QCheckBox *hideGridsLinesCheckBox;
    QGroupBox *groupBoxSensorOptions;
    QGridLayout *gridLayout_8;
    QCheckBox *checkBoxTypeOfMount;
    ...
    QDoubleSpinBox *OAGDist;
    QLabel *OAGDist_lbl;
    QLabel *OAGPrismH_lbl;
    QDoubleSpinBox *OAGPrismH;
    QLabel *OAGPrismW_lbl;
    QLabel *OAGPrismPA_lbl;
    QDoubleSpinBox *OAGPrismW;
    QCheckBox *OAG_checkBox;
    QDoubleSpinBox *OAGPrismPA;
    QLabel *ccdRotAngle_lbl;
    QDoubleSpinBox *ccdRotAngle;
    ...
    void setupUi(QWidget *ocularDialogForm)
    {
        ...
        ocularDialogForm->resize(646, 609);
        ...
        gridLayout_7 = new QGridLayout(groupBoxInterface);
        ...
        gridLayout_6 = new QGridLayout(groupBoxOcularOptions);
        ...
        gridLayout_6->addWidget(requireSelectionCheckBox, 0, 0, 1, 1);
        ...
        gridLayout_6->addWidget(limitStellarMagnitudeCheckBox, 3, 0, 1, 1);
        ...
        gridLayout_6->addWidget(scaleImageCircleCheckBox, 0, 1, 1, 1);

        semiTransparencyCheckBox = new QCheckBox(groupBoxOcularOptions);
        semiTransparencyCheckBox->setObjectName(QStringLiteral("semiTransparencyCheckBox"));

        gridLayout_6->addWidget(semiTransparencyCheckBox, 3, 1, 1, 1);

        hideGridsLinesCheckBox = new QCheckBox(groupBoxOcularOptions);
        hideGridsLinesCheckBox->setObjectName(QStringLiteral("hideGridsLinesCheckBox"));

        gridLayout_6->addWidget(hideGridsLinesCheckBox, 4, 0, 1, 1);
        ...
        gridLayout_8 = new QGridLayout(groupBoxSensorOptions);
        gridLayout_8->setObjectName(QStringLiteral("gridLayout_8"));
        gridLayout_8->setContentsMargins(0, 0, 0, 0);
        checkBoxTypeOfMount = new QCheckBox(groupBoxSensorOptions);
        checkBoxTypeOfMount->setObjectName(QStringLiteral("checkBoxTypeOfMount"));

        gridLayout_8->addWidget(checkBoxTypeOfMount, 2, 0, 1, 1);
        ...
        gridLayout_8->addWidget(checkBoxDecimalDegrees, 1, 0, 1, 1);
        ...
        labelName = new QLabel(OcularData);
        ...
        OAGDist = new QDoubleSpinBox(CCDData);
        OAGDist->setObjectName(QStringLiteral("OAGDist"));
        OAGDist->setDecimals(2);
        OAGDist->setSingleStep(0.1);

        gridLayout_4->addWidget(OAGDist, 9, 1, 1, 1);

        OAGDist_lbl = new QLabel(CCDData);
        OAGDist_lbl->setObjectName(QStringLiteral("OAGDist_lbl"));

        gridLayout_4->addWidget(OAGDist_lbl, 9, 0, 1, 1);

        OAGPrismH_lbl = new QLabel(CCDData);
        OAGPrismH_lbl->setObjectName(QStringLiteral("OAGPrismH_lbl"));

        gridLayout_4->addWidget(OAGPrismH_lbl, 10, 0, 1, 1);

        OAGPrismH = new QDoubleSpinBox(CCDData);
        OAGPrismH->setObjectName(QStringLiteral("OAGPrismH"));
        OAGPrismH->setDecimals(2);
        OAGPrismH->setSingleStep(0.1);

        gridLayout_4->addWidget(OAGPrismH, 10, 1, 1, 1);

        OAGPrismW_lbl = new QLabel(CCDData);
        OAGPrismW_lbl->setObjectName(QStringLiteral("OAGPrismW_lbl"));

        gridLayout_4->addWidget(OAGPrismW_lbl, 11, 0, 1, 1);

        OAGPrismPA_lbl = new QLabel(CCDData);
        OAGPrismPA_lbl->setObjectName(QStringLiteral("OAGPrismPA_lbl"));

        gridLayout_4->addWidget(OAGPrismPA_lbl, 12, 0, 1, 1);

        OAGPrismW = new QDoubleSpinBox(CCDData);
        OAGPrismW->setObjectName(QStringLiteral("OAGPrismW"));
        OAGPrismW->setDecimals(2);
        OAGPrismW->setSingleStep(0.1);

        gridLayout_4->addWidget(OAGPrismW, 11, 1, 1, 1);

        OAG_checkBox = new QCheckBox(CCDData);
        OAG_checkBox->setObjectName(QStringLiteral("OAG_checkBox"));

        gridLayout_4->addWidget(OAG_checkBox, 8, 0, 1, 2);

        OAGPrismPA = new QDoubleSpinBox(CCDData);
        OAGPrismPA->setObjectName(QStringLiteral("OAGPrismPA"));
        OAGPrismPA->setDecimals(0);
        OAGPrismPA->setMinimum(0);
        OAGPrismPA->setMaximum(360);
        OAGPrismPA->setSingleStep(1);

        gridLayout_4->addWidget(OAGPrismPA, 12, 1, 1, 1);

        ccdRotAngle_lbl = new QLabel(CCDData);
        ccdRotAngle_lbl->setObjectName(QStringLiteral("ccdRotAngle_lbl"));

        gridLayout_4->addWidget(ccdRotAngle_lbl, 7, 0, 1, 1);

        ccdRotAngle = new QDoubleSpinBox(CCDData);
        ccdRotAngle->setObjectName(QStringLiteral("ccdRotAngle"));
        ccdRotAngle->setDecimals(0);
        ccdRotAngle->setMinimum(-360);
        ccdRotAngle->setMaximum(360);

        gridLayout_4->addWidget(ccdRotAngle, 7, 1, 1, 1);
        ...
        telescopeFL->setDecimals(2);
        telescopeFL->setMinimum(1);
        telescopeFL->setMaximum(1e+07);
        ...
        telescopeDiameter->setDecimals(2);
        telescopeDiameter->setMinimum(1);
        telescopeDiameter->setMaximum(999999);
        ...
        telescopeEQ = new QCheckBox(ScopeInfo);
        telescopeEQ->setObjectName(QStringLiteral("telescopeEQ"));

        gridLayout_5->setWidget(5, QFormLayout::SpanningRole, telescopeEQ);
        ...
        QWidget::setTabOrder(requireSelectionCheckBox, ocularListView);
        ...
        QWidget::setTabOrder(telescopeVFlip, telescopeEQ);
        QWidget::setTabOrder(telescopeEQ, textBrowser);
    ...
    void retranslateUi(QWidget *ocularDialogForm)
    {
...
#ifndef QT_NO_TOOLTIP
        semiTransparencyCheckBox->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        semiTransparencyCheckBox->setText(QApplication::translate("ocularDialogForm", "Use semi-transparent mask", 0));
        hideGridsLinesCheckBox->setText(QApplication::translate("ocularDialogForm", "Hide grids and lines when enabled", 0));
        groupBoxSensorOptions->setTitle(QApplication::translate("ocularDialogForm", "Sensor view", 0));
#ifndef QT_NO_TOOLTIP
        checkBoxTypeOfMount->setToolTip(QApplication::translate("ocularDialogForm", "Enable automatic switch of mount type from the telescope settings for horizontal orientation of CCD frame.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxTypeOfMount->setText(QApplication::translate("ocularDialogForm", "Enable automatic switch of mount type", 0));
        ...
        labelName->setText(QApplication::translate("ocularDialogForm", "Name:", 0));
        labelFOV->setText(QApplication::translate("ocularDialogForm", "aFOV:", 0));
        labelFL->setText(QApplication::translate("ocularDialogForm", "Focal length:", 0));
        labelFS->setText(QApplication::translate("ocularDialogForm", "Field stop:", 0));
        ...
        OAGDist_lbl->setText(QApplication::translate("ocularDialogForm", "Prism/CCD distance (mm):", 0));
        OAGPrismH_lbl->setText(QApplication::translate("ocularDialogForm", "Prism/CCD height (mm):", 0));
        OAGPrismW_lbl->setText(QApplication::translate("ocularDialogForm", "Prism/CCD width (mm):", 0));
        OAGPrismPA_lbl->setText(QApplication::translate("ocularDialogForm", "Position angle (degrees):", 0));
        OAG_checkBox->setText(QApplication::translate("ocularDialogForm", "Off-Axis guider", 0));
        ccdRotAngle_lbl->setText(QApplication::translate("ocularDialogForm", "Rotation Angle (degrees):", 0));
        ...
        telescopeEQ->setText(QApplication::translate("ocularDialogForm", "Equatorial Mount", 0));
