...
public:
    ...
    QTreeWidget *iridiumFlaresTreeWidget;
    QPushButton *pushButtonPredictIridiumFlares;
    QWidget *aboutTab;
    ...
    void setupUi(QWidget *satellitesDialog)
    {
        ...
        sizePolicy1.setHeightForWidth(checkBoxAutoAdd->sizePolicy().hasHeightForWidth());
        checkBoxAutoAdd->setSizePolicy(sizePolicy1);
        ...
        sizePolicy3.setHeightForWidth(fontSizeSpinBox->sizePolicy().hasHeightForWidth());
        fontSizeSpinBox->setSizePolicy(sizePolicy3);
        ...
        groupFilterCombo->setEditable(true);
        groupFilterCombo->setInsertPolicy(QComboBox::NoInsert);
        ...
        sizePolicy4.setHeightForWidth(addSatellitesButton->sizePolicy().hasHeightForWidth());
        addSatellitesButton->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(removeSatellitesButton->sizePolicy().hasHeightForWidth());
        removeSatellitesButton->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(commsButton->sizePolicy().hasHeightForWidth());
        commsButton->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(saveSatellitesButton->sizePolicy().hasHeightForWidth());
        saveSatellitesButton->setSizePolicy(sizePolicy4);
        ...
        iridiumTab = new QWidget();
        iridiumTab->setObjectName(QStringLiteral("iridiumTab"));
        gridLayout = new QGridLayout(iridiumTab);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        iridiumFlaresTreeWidget = new QTreeWidget(iridiumTab);
        iridiumFlaresTreeWidget->setObjectName(QStringLiteral("iridiumFlaresTreeWidget"));
        iridiumFlaresTreeWidget->setEditTriggers(QAbstractItemView::NoEditTriggers);
        iridiumFlaresTreeWidget->setSortingEnabled(true);
        iridiumFlaresTreeWidget->setExpandsOnDoubleClick(false);
        iridiumFlaresTreeWidget->setColumnCount(0);

        gridLayout->addWidget(iridiumFlaresTreeWidget, 0, 0, 1, 1);

        pushButtonPredictIridiumFlares = new QPushButton(iridiumTab);
        pushButtonPredictIridiumFlares->setObjectName(QStringLiteral("pushButtonPredictIridiumFlares"));

        gridLayout->addWidget(pushButtonPredictIridiumFlares, 1, 0, 1, 1);

        tabs->addTab(iridiumTab, QString());
    ...
    void retranslateUi(QWidget *satellitesDialog)
    {
        ...
        pushButtonPredictIridiumFlares->setText(QApplication::translate("satellitesDialog", "Predict Iridium flares", 0));
        tabs->setTabText(tabs->indexOf(iridiumTab), QApplication::translate("satellitesDialog", "Iridium flares", 0));
