...
public:
    ...
    void setupUi(QWidget *equationOfTimeWindowForm)
    {
        ...
        equationOfTimeWindowForm->resize(500, 472);
        ...
        sizePolicy1.setHeightForWidth(labelEOTDescription->sizePolicy().hasHeightForWidth());
        labelEOTDescription->setSizePolicy(sizePolicy1);
