/****************************************************************************
** Meta object code from reading C++ file 'LocationService.hpp'
**
...
#include "../../../../../../plugins/RemoteControl/src/LocationService.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'LocationService.hpp' doesn't include <QObject>."
...
const QMetaObject LocationService::staticMetaObject = {
    { &AbstractAPIService::staticMetaObject, qt_meta_stringdata_LocationService.data,
