/****************************************************************************
** Meta object code from reading C++ file 'APIController.hpp'
**
...
#include "../../../../../../plugins/RemoteControl/src/APIController.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'APIController.hpp' doesn't include <QObject>."
...
const QMetaObject APIController::staticMetaObject = {
    { &HttpRequestHandler::staticMetaObject, qt_meta_stringdata_APIController.data,
      qt_meta_data_APIController,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *APIController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_APIController.stringdata0))
        return static_cast<void*>(const_cast< APIController*>(this));
